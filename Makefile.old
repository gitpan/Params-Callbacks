# This Makefile is for the Params::Callbacks extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Params/Callbacks.pm]
#     AUTHOR => [q[Iain Campbell <cpanic@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Params::Callbacks]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Params/Callbacks.pm]
...
MAKE = make
FULLEXT = Params/Callbacks
BASEEXT = Callbacks
PARENT_NAME = Params
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Params/Callbacks.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Params/Callbacks.pm
...
TO_INST_PM = lib/Params/Callbacks.pm

PM_TO_BLIB = lib/Params/Callbacks.pm \
...
DISTNAME = Params-Callbacks
DISTVNAME = Params-Callbacks-1.00
...
manifypods : pure_all  \
	lib/Params/Callbacks.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Params/Callbacks.pm $(INST_MAN3DIR)/Params::Callbacks.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''callback helper and topicalizer tools'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Iain Campbell <cpanic@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Params-Callbacks' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "callback helper and topicalizer tools",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Iain Campbell <cpanic@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Params-Callbacks",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>callback helper and topicalizer tools</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Iain Campbell &lt;cpanic@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Params/Callbacks.pm blib/lib/Params/Callbacks.pm 
